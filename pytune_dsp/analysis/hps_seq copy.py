...
# ===== Tunables (ENV) ========================================================
# → Defaults = comportement actuel (aucune régression si non définies)
...
# Seuil qui classe la tessiture en "high" quand topF >= HPS_HIGH_TOPF
HPS_HIGH_TOPF  = float(os.getenv("HPS_HIGH_TOPF", "1000"))

# Tolérances (cents) et hmax par tessiture
...
# Limitation des seeds h en aigu (par défaut: inchangé = 6)
